 ...
 * jpeducation
 * <p>
 * Created by sjl on 2020/8/28
 * Copyright © 2020年 weibo. All rights reserved.
 * <p>
 * Describe:
 */
public class CheckWrongOrCollectQuestionsAdapter extends RecyclerView.Adapter<CheckWrongOrCollectQuestionsAdapter.MyHolder> {


    private List<AnswerBean> answerBeans;
    private Context context;
    private String type;//1.单选，2多选，5不能点击


    public CheckWrongOrCollectQuestionsAdapter(List<AnswerBean> answerBeans, Context context) {
