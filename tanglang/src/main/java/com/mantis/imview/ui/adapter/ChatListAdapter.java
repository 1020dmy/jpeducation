...
import com.mantis.core.gson.Gson;
...
public class ChatListAdapter extends RecyclerView.Adapter<ChatListAdapter.ChatViewHolder> {
    ...
    public class ChatViewHolder extends RecyclerView.ViewHolder {
        private RelativeLayout item_chat_root;
        private FlowGroupView item_chat_select_content;
        private HtmlTextView item_chat_content;
        ...
        private ChatViewHolder(@NonNull View itemView) {
            ...
            item_chat_root = itemView.findViewById(R.id.item_chat_root);
        }
        ...
        private void setData(ChatEntity chatEntity, int position) {
            ...
            if (chatEntity.getType().equals(MantisCommon.TEXT)) {
                ...
                if (chatEntity.getStatus() == MantisCommon.RECEIVE && chatEntity.isWelcome()) {
                    ...
                    HtmlHttpImageGetter htmlHttpImageGetter = new HtmlHttpImageGetter(item_chat_content, activity);
                    htmlHttpImageGetter.enableCompressImage(true);
                    item_chat_content.setHtml(EmojiUtil.emojiDecode(chatEntity.getShowContent()), htmlHttpImageGetter);
